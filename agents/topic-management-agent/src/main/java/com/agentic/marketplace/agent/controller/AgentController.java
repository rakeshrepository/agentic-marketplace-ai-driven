...
public class AgentController {
    ...
    public ResponseEntity<AgentResponse> health() {
        return ResponseEntity.ok(AgentResponse.builder()
                .success(true)
                .message("Topic Management Agent is running")
                .build());
    }
    ...
    public ResponseEntity<AgentResponse> info() {
        return ResponseEntity.ok(AgentResponse.builder()
                .success(true)
                .message("Kafka Topic Management Agent")
                .data(java.util.Map.of(
                        "id", "topic-management-agent",
                        "name", "Kafka Topic Management Agent",
                        "category", "infrastructure",
                        "capabilities", java.util.List.of("create-topic", "list-topics", "delete-topic", "describe-topic")
                ))
                .build());
    }
}
